...
d1 = (eye(3) - (v_kw * v_kw')) * (v_r - uvms.vTb(1:3, 4));
uvms.A.dr = eye(3) .* IncreasingBellShapedFunction(0.5, 0.7, 0, 1, norm(d1)) .* ActionTransition("DR", previous_tasks, current_tasks, mission.phase_time);
