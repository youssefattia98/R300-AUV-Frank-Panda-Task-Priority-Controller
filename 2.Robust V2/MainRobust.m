...
mission.actions.alignment.tasks = ["HR"];
mission.actions.landing.tasks = ["HA", "DR", "A"];
mission.actions.reachingrock.tasks = ["JL", "DEX", "FB", "RRT", "RRR"];
...
for t = 0:deltat:end_time
    ...
    [Qp, ydotbar] = iCAT_task(uvms.A.jl,    uvms.Jv_jl,    Qp, ydotbar, uvms.xdot.jl,  0.0001,   0.01, 10); % Arm Joint limit
    [Qp, ydotbar] = iCAT_task(uvms.A.dex,    uvms.Jv_dex,    Qp, ydotbar, uvms.xdot.dex,  0.0001,   0.01, 10); % Arm manipulability
    [Qp, ydotbar] = iCAT_task(uvms.A.fb,    uvms.Jv_fb,    Qp, ydotbar, uvms.xdot.fb,  0.0001,   0.01, 10); % Vehicle null velocity
    [Qp, ydotbar] = iCAT_task(uvms.A.rrr,    uvms.Jv_rrr,    Qp, ydotbar, uvms.xdot.rrr,  0.0001,   0.01, 10); % End effector linear position
    [Qp, ydotbar] = iCAT_task(uvms.A.rrt,    uvms.Jv_rrt,    Qp, ydotbar, uvms.xdot.rrt,  0.0001,   0.01, 10); % End effector angular position
    [Qp, ydotbar] = iCAT_task(uvms.A.ma,    uvms.Jma,    Qp, ydotbar, uvms.xdot.ma,  0.0001,   0.01, 10); % vehicle minimum altitude
    [Qp, ydotbar] = iCAT_task(uvms.A.ha,    uvms.Jha,    Qp, ydotbar, uvms.xdot.ha,  0.0001,   0.01, 10); % vehicle horizontal attitude
    [Qp, ydotbar] = iCAT_task(uvms.A.v_o,    uvms.Jv_o,    Qp, ydotbar, uvms.xdot.v_o,  0.0001,   0.01, 10); % Vehicle heading control
    [Qp, ydotbar] = iCAT_task(uvms.A.v_d,    uvms.Jv_d,    Qp, ydotbar, uvms.xdot.v_d,  0.0001,   0.01, 10); % Vehicle position control
    [Qp, ydotbar] = iCAT_task(uvms.A.hr,    uvms.Jv_hr,    Qp, ydotbar, uvms.xdot.v_hr,  0.0001,   0.01, 10); % Vehicle position longitudinal alignment to the nodule
    [Qp, ydotbar] = iCAT_task(uvms.A.dr,    uvms.Jv_dr,    Qp, ydotbar, uvms.xdot.v_dr,  0.0001,   0.01, 10); % Vehicle distance to the nodule
    [Qp, ydotbar] = iCAT_task(uvms.A.a,    uvms.Ja,    Qp, ydotbar, uvms.xdot.a,  0.0001,   0.01, 10); % Vehicle altitude control
