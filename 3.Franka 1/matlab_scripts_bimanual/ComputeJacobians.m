...
pandaArm.Jg1 = [[zeros(3, 7); pandaArm.ArmL.Jw_o(4:6, :)] zeros(6, 7); zeros(6, 7) [zeros(3, 7); pandaArm.ArmR.Jw_o(4:6, :)]];

% Reaching goal2 jacobian
pandaArm.Jg2 = [[zeros(3, 7); pandaArm.ArmL.Jw_o(4:6, :)] zeros(6, 7); zeros(6, 7) [zeros(3, 7); pandaArm.ArmR.Jw_o(4:6, :)]];
