...
pandaArm.ArmL.A.rg2 = eye(6) .* ActionTransition("RG2L", previous_tasks, current_tasks, mission.phase_time); 
pandaArm.ArmR.A.rg2 = eye(6) .* ActionTransition("RG2R", previous_tasks, current_tasks, mission.phase_time); 
