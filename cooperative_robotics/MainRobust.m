...
mission.actions.landing.tasks = ["HA", "HR", "DR", "A"]; % here there was even the V_D but i'm not sure it was right, it should be distance to the nodule, or better the projection of it on the horizontal plane
