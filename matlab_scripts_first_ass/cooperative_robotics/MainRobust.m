...
mission.phase = 1;
mission.phase_time = 0;
mission.actions.go_to.tasks = ["MA", "HA", "V_D", "V_O"];
mission.actions.landing.tasks = ["HA", "A", "V_D", "HR"];
mission.actions.reachingrock.tasks = ["FB", "RR"];
...
for t = 0:deltat:end_time
    ...
    %[Qp, ydotbar] = iCAT_task(uvms.A.rr,    uvms.Jv_rr,    Qp, ydotbar, uvms.xdot.rr,  0.0001,   0.01, 10);
    [Qp, ydotbar] = iCAT_task(uvms.A.fb,    uvms.Jv_fb,    Qp, ydotbar, uvms.xdot.fb,  0.0001,   0.01, 10);
